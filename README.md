...
This project uses four JSON files containing seed data for users, venues, events, and RSVPs.

To reset the database and populate the tables with the seed data, run the following command from the project root:
   ```bash
   python -m db.seed
   ```